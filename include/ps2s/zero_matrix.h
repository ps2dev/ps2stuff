...
inline mat_33 zero_33::operator + ( const mat_33& mat ) const return result; { result = mat; }
inline mat_33 zero_33::operator - ( const mat_33& mat ) const return result; { result = -mat; }
...
inline mat_43 zero_43::operator + ( const mat_43& mat ) const return result; { result = mat; }
inline mat_43 zero_43::operator - ( const mat_43& mat ) const return result; { result = -mat; }
...
inline mat_34 zero_34::operator + ( const mat_34& mat ) const return result; { result = mat; }
inline mat_34 zero_34::operator - ( const mat_34& mat ) const return result; { result = -mat; }
...
inline mat_44 zero_44::operator + ( const mat_44& mat ) const return result; { result = mat; }
inline mat_44 zero_44::operator - ( const mat_44& mat ) const return result; { result = -mat; }
...
inline mat_33 mat_33::operator + ( const zero_33 zero ) const return result; { result = *this; }
inline mat_33 mat_33::operator - ( const zero_33 zero ) const return result; { result = *this; }
inline void mat_33::operator += ( const zero_33 zero ) { }
inline void mat_33::operator -= ( const zero_33 zero ) { }
inline mat_33& mat_33::operator = ( const zero_33 zero ) { set_zero(); return *this; }
...
inline mat_43 mat_43::operator + ( const zero_43 zero ) const return result; { result = *this; }
inline mat_43 mat_43::operator - ( const zero_43 zero ) const return result; { result = *this; }
inline void mat_43::operator += ( const zero_43 zero ) { }
inline void mat_43::operator -= ( const zero_43 zero ) { }
inline mat_43& mat_43::operator = ( const zero_43 zero ) { set_zero(); return *this; }
...
inline mat_34 mat_34::operator + ( const zero_34 zero ) const return result; { result = *this; }
inline mat_34 mat_34::operator - ( const zero_34 zero ) const return result; { result = *this; }
inline void mat_34::operator += ( const zero_34 zero ) { }
inline void mat_34::operator -= ( const zero_34 zero ) { }
inline mat_34& mat_34::operator = ( const zero_34 zero ) { set_zero(); return *this; }
...
inline mat_44 mat_44::operator + ( const zero_44 zero ) const return result; { result = *this; }
inline mat_44 mat_44::operator - ( const zero_44 zero ) const return result; { result = *this; }
inline void mat_44::operator += ( const zero_44 zero ) { }
inline void mat_44::operator -= ( const zero_44 zero ) { }
inline mat_44& mat_44::operator = ( const zero_44 zero ) { set_zero(); return *this; }
