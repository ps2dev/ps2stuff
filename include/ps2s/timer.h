...
{
   public:
      static void InitHierarchy( CEETimer* realTimer, CEETimer::tResolution resolution );
   ...
   protected:
	 ...
	 : Name(name), pUniqueName(name), uiElapsedTicks(0), Children() {
	 ...
	 return ticks;
      ...
      void AddChild( CHTimer* newChild ) {
