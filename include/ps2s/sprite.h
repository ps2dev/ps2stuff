...
class CSprite
{
   public:
	 ...
	 Color[0] = r; Color[1] = g; Color[2] = b; Color[3] = a; Vertex2[3] = (tU32)fog << 4;
      }
      void SetColor( tU32 rgba ) {
	 Color[0] = 0xff & rgba; Color[1] = (0xff00 & rgba) >> 8;
	 Color[2] = (0xff0000 & rgba) >> 16; Color[3] = (0xff000000 & rgba) >> 24;
      }
	 ...
	 Vertex1[0] = minX << 4; Vertex1[1] = minY << 4;
	 Vertex2[0] = (minX + width) << 4; Vertex2[1] = (minY + height) << 4;
      }
