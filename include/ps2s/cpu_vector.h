...
class cpu_vec_4
{
   public:
	 ...
	 asm volatile (
      ...
      explicit inline cpu_vec_4( const vector_t vec ) { set(vec.vec128); w = 0.0f; }
      explicit inline cpu_vec_4( const point_t vec ) { set(vec.vec128); w = 1.0f; }
#endif
...
#ifndef NO_VU0_VECTORS
inline
vec_xyz::vec_xyz( const cpu_vec_3 &rhs ) {
...
inline
vector_t::vector_t( const cpu_vec_3 &rhs ) {
...
inline
point_t::point_t( const cpu_vec_3 &rhs ) {
...
inline
vec_xyzw::vec_xyzw( const cpu_vec_4 &rhs ) {
