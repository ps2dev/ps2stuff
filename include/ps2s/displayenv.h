...
namespace GS {
   ...
   namespace DisplayModes {
      typedef enum { ntsc, pal, dtv } tDisplayMode;
   }
   ...
   class CDisplayEnv
   {
	 ...
	 inline void BlendUsingConstAlpha( tU8 alpha ) { gsrPMode.MMOD = 1; gsrPMode.ALP = alpha; }
	 void DontBlend( void );

	 inline void SetBGColor( tU8 r, tU8 g, tU8 b ) {
	    gsrBGColor.R = r; gsrBGColor.G = g, gsrBGColor.B = b;
	 }
   ...
   void
   CDisplayEnv::GsDisplayModeIs( tDisplayMode mode )
   {
   ...
   void
   CDisplayEnv::SetDisplay1( unsigned int width, unsigned int height,
			     unsigned int screenX, unsigned int screenY,
			     unsigned int magH, unsigned int magV )
   {
   ...
   void
   CDisplayEnv::SetDisplay2( unsigned int width, unsigned int height,
			     unsigned int screenX, unsigned int screenY,
			     unsigned int magH, unsigned int magV )
   {
