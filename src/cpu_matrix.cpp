...
void
cpu_mat_44::set_rotate( float angle, cpu_vec_xyz axis )
{
   axis.normalize();
...
cpu_mat_44::transpose() const return result;
{
   ...
   result.col0[2] = col2(0); result.col2[0] = col0(2);
   result.col0[3] = col3(0); result.col3[0] = col0(3);
   result.col1[3] = col3(1); result.col3[1] = col1(3);
