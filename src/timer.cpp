...
void
CHTimer::InitHierarchy( CEETimer* realTimer, CEETimer::tResolution resolution )
{
...
void
CHTimer::Display( const std::string& path )
{
   printf("%s%.2f%% - %s\n",
	  path.c_str(),
